    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button icon="Refresh" type="primary" @click="genApi.autoImport">导入表数据</el-button>
          </el-col>
      ...
      <el-table v-loading="loading" :data="dataList" max-height="522px" @selection-change="selectionChange">
        ...
        <el-table-column :show-overflow-tooltip="true" label="表备注" prop="tableComment" width="150"/>
        <el-table-column :show-overflow-tooltip="true" label="实体类名称" prop="className" width="150"/>
        <el-table-column :show-overflow-tooltip="true" label="模板类型" prop="templateType" width="80"/>
        <el-table-column :show-overflow-tooltip="true" label="包路径" prop="packageName" width="150"/>
        <el-table-column :show-overflow-tooltip="true" label="模块名" prop="moduleName" width="80"/>
        ...
        <el-table-column :show-overflow-tooltip="true" label="父类" prop="superClass" width="200"/>
        ...
        <el-table-column align="center" class-name="small-padding fixed-width" label="操作" width="200">
          <template #default="scope">
            ...
            <el-tooltip content="修改" placement="top">
              ...
              <el-button icon="Edit" link type="primary" @click="generateRef.open(scope.row.id)"></el-button>
            </el-tooltip>
