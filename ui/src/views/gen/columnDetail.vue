  ...
  <el-drawer v-model="visible" size="100%" @close="close">
    ...
    <template #default>
      <el-table v-loading="loading" :data="dataList" max-height="600px" scrollbar-always-on stripe>
        <el-table-column :min-width="130" :show-overflow-tooltip="true" fixed label="列名" prop="columnName"/>
        <el-table-column :min-width="130" :show-overflow-tooltip="true" label="列注释" prop="columnComment"/>
        <el-table-column :min-width="100" :show-overflow-tooltip="true" label="列类型" prop="dataType"/>
        ...
        <el-table-column :min-width="100" :show-overflow-tooltip="true" label="父类字段" prop="superColumn"/>
        ...
        <el-table-column :min-width="100" :show-overflow-tooltip="true" label="数据字典" prop="dictType"/>
