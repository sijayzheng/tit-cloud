package cn.sijay.common.web.aspect;
...
public class LogAspect {
    ...
    public void doAfterThrowing(JoinPoint point, OprLog log, Exception e) {
        handleLog(point, log, null, e);
    }

    void handleLog(final JoinPoint point, OprLog log, Object result, final Exception e) {
